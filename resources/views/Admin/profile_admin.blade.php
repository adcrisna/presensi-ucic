                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <form action="{{ route('update_profileAdmin') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group has-feedback">
                                <label>Nama :</label>
                                <input type="text" name="nama" class="form-control" value="{{ $admin->nama_user }}"
                                    require>
                            </div>
                            <div class="form-group has-feedback">
                                <label>Email :</label>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="jabatan" class="form-control"
                                    value="{{ $admin->nama_jabatan }}" readonly>
                            </div>
                            <div class="form-group has-feedback">
                                <label>Alamat</label>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="hidden" name="foto_lama" class="form-control"
                                    value="{{ $admin->foto_user }}">
