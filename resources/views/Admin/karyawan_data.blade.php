                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-info btn-xs" data-toggle="modal"
                                data-target="#modal-form-tambah-karyawan"><i class="fa fa-user-plus"> Tambah Akun Karyawan
                                </i></button>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-karyawan"><i class="fa fa-edit">
                                                    Ubah Akun</i></button> &nbsp;
                                            <a href="{{ route('delete_karyawan', $value->id) }}"><button
                                                    class=" btn btn-xs btn-danger"
                                                    onclick="return confirm('Apakah anda ingin menghapus data ini ?')"><i
                                                        class="fa fa-trash"> Hapus Akun</i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <select class="form-control" id="nama_jabatan" name="nama_jabatan">
                                @foreach ($jabatan as $key => $value)
                                    <option value="{{ $value->nama_jabatan }}" data-id="{{ $value->jabatan_id }}">
                                        {{ $value->nama_jabatan }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="hidden" name="id_jabatan" id="id_jabatan" class="form-control" readonly
                                required>
                        </div>
                        <div class="form-group has-feedback">
                    ...
                    <form action="{{ route('update_karyawan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <select class="form-control" id="nama_jabatan_edit" name="nama_jabatan_edit">
                                @foreach ($jabatan as $key => $value)
                                    <option value="{{ $value->nama_jabatan }}" data-id_edit="{{ $value->jabatan_id }}">
                                        {{ $value->nama_jabatan }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            <input type="hidden" name="id_jabatan" id="id_jabatan_edit" class="form-control" readonly
                                required>
                        </div>
                        <div class="form-group has-feedback">
